...
import imageio.v2 as imageio  # Sử dụng imageio.v2 để tránh cảnh báo
from PIL import Image  # Đưa import này vào đây
                    ...
                    try:
                        ...
                        if nrof_faces > 0:
                            ...
                            for i in range(nrof_faces):
                                ...
                                cropped = Image.fromarray(cropped.astype(np.uint8))  # Chuyển đổi sang đối tượng Image
                                scaled = cropped.resize((args.image_size, args.image_size), Image.BILINEAR)
                                nrof_successfully_aligned += 1
                                if args.detect_multiple_faces:
                                    output_filename_n = "{}_{}{}".format(output_filename, i, '.png')
                                else:
